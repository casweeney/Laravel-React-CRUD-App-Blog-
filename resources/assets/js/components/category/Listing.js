...
export default class Listing extends Component {
    ...
    handlePageChange(pageNumber) {
        ...
        //http://localhost:8000/category?page=1
    ...
    render() {
        return (
            <div>
                ...
                {this.state.alert_message=="error"?<ErrorAlert message={"An error occured while deleting category."} />:null}
